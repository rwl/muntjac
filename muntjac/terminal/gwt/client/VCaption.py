...
class VCaption(HTML):
    ...
    def updateCaption(self, uidl):
        ...
        if hasIcon:
            if self._icon is None:
                ...
                DOM.insertChild(self.getElement(), self._icon.getElement(), self.getInsertPosition(self.ATTRIBUTE_ICON))
        ...
        if hasText:
            ...
            if self._captionText is None:
                ...
                DOM.insertChild(self.getElement(), self._captionText, self.getInsertPosition(self.ATTRIBUTE_CAPTION))
            # Update caption text
        ...
        if showError:
            if self._errorIndicatorElement is None:
                ...
                DOM.insertChild(self.getElement(), self._errorIndicatorElement, self.getInsertPosition(self.ATTRIBUTE_ERROR))
    ...
    def onBrowserEvent(self, event):
        ...
        if (
            DOM.eventGetType(event) == Event.ONLOAD and self._icon.getElement() == target and not self._iconOnloadHandled
        ):
            self._icon.setWidth('')
