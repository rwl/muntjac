...
class FocusableFlowPanel(FlowPanel, HasFocusHandlers, HasBlurHandlers,
    ...
    def setFocus(self, focus):
        ...
        @param focus:
                   If set to true then the focus is moved to the panel, if
                   set to false the focus is removed
        """
        if focus:
