...
class VCustomLayout(ComplexPanel, Paintable, Container, ContainerResizedListener):
    ...
    def __init__(self):
        ...
        self.DOM.setStyleAttribute(self.getElement(), 'border', 'none')
        self.DOM.setStyleAttribute(self.getElement(), 'margin', '0')
        self.DOM.setStyleAttribute(self.getElement(), 'padding', '0')
    ...
    def initializeHTML(self, uidl, client):
        ...
        self._elementWithNativeResizeFunction = self.DOM.getFirstChild(self.getElement())
    ...
    def scanForLocations(self, elem):
        ...
        if not ('' == location):
            ...
            len = self.DOM.getChildCount(elem)
            _0 = True
            i = 0
            while True:
                if _0 is True:
                ...
                if not (i < len):
                    break
                self.scanForLocations(self.DOM.getChild(elem, i))
    ...
    def initImgElements(self):
        ...
        while True:
            ...
            self.DOM.sinkEvents(img, self.Event.ONLOAD)
    ...
    def iLayout(self):
        self.iLayoutJS(self.DOM.getFirstChild(self.getElement()))
