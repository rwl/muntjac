...
#    };
    ...
    def layoutSizeMightHaveChanged(self):
        oldSize = self.Size(self._activeLayoutSize.getWidth(), self._activeLayoutSize.getHeight())
    ...
    def setOuterLayoutWidth(self, activeLayoutWidth):
        ...
        self.getElement().getStyle().setWidth(newPixelWidth, self.Unit.PX)
    ...
    def setOuterLayoutHeight(self, activeLayoutHeight):
        ...
        self.getElement().getStyle().setHeight(newPixelHeight, self.Unit.PX)
    ...
    def requestLayout(self, children):
        ...
        sizeBefore = self.Size(self._activeLayoutSize.getWidth(), self._activeLayoutSize.getHeight())
