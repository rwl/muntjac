...
class VRichTextArea(Composite, Paintable, Field, ChangeHandler, BlurHandler, KeyPressHandler, KeyDownHandler, BeforeShortcutActionListener, Focusable):
    ...
    def selectAll(self):
        ...
        class _0_(Timer):
            ...
            def run(self):
                VRichTextArea_this._rta.getFormatter().selectAll()
    ...
    def setHeight(self, height):
        ...
        if (height is None) or (height == ''):
            ...
            class _1_(Command):
                ...
                def execute(self):
                    editorHeight = self.getOffsetHeight() - VRichTextArea_this.getExtraVerticalPixels() - VRichTextArea_this._formatter.getOffsetHeight()
                    if editorHeight < 0:
                        editorHeight = 0
                    VRichTextArea_this._rta.setHeight(editorHeight + 'px')
    ...
    def onKeyPress(self, event):
        if self._maxLength >= 0:
            ...
            class _2_(Command):
                ...
                def execute(self):
                    if len(VRichTextArea_this._rta.getHTML()) > VRichTextArea_this._maxLength:
                        VRichTextArea_this._rta.setHTML(VRichTextArea_this._rta.getHTML()[:VRichTextArea_this._maxLength])
    ...
    def setFocus(self, focused):
        ...
        class _3_(Timer):
            ...
            def run(self):
                VRichTextArea_this._rta.setFocus(True)
