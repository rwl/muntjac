...
class Property(Serializable):
    ...
    class Editor(Property.Viewer, Serializable):
    ...
    class ValueChangeEvent(Serializable):
    ...
    class ValueChangeListener(Serializable):
    ...
    class ValueChangeNotifier(Serializable):
    ...
    class ReadOnlyStatusChangeEvent(Serializable):
    ...
    class ReadOnlyStatusChangeListener(Serializable):
    ...
    class ReadOnlyStatusChangeNotifier(Serializable):
