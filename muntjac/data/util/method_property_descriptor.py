...
from muntjac.data.util.method_property import MethodProperty

from muntjac.data.util.muntjac_property_descriptor import \
    MuntjacPropertyDescriptor


logger = logging.getLogger(__name__)


class MethodPropertyDescriptor(MuntjacPropertyDescriptor):
