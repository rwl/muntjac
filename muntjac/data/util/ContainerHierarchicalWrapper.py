...
from muntjac.data.Container import \
    Container, Hierarchical, ItemSetChangeListener, ItemSetChangeNotifier, \
    PropertySetChangeListener, PropertySetChangeNotifier

from muntjac.data.util.HierarchicalContainer import HierarchicalContainer


class ContainerHierarchicalWrapper(Container, Hierarchical, Container,
    ...
    def __init__(self, toBeWrapped):
        ...
        self._hierarchical = isinstance(self._container, Hierarchical)
...
class PiggybackListener(Container, PropertySetChangeListener, Container,
    ...
    def containerItemSetChange(self, event):
        self.wrapper.updateHierarchicalWrapper()
