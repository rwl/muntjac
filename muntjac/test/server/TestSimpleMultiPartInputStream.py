# -*- coding: utf-8 -*-
# from com.vaadin.terminal.gwt.server.AbstractCommunicationManager.SimpleMultiPartInputStream import (SimpleMultiPartInputStream,)
# from java.util.Arrays import (Arrays,)
# from junit.framework.TestCase import (TestCase,)


class TestSimpleMultiPartInputStream(TestCase):
