...
The L{com.vaadin.ui.Component} interface is the top-level
...
implementing the L{com.vaadin.ui.ComponentContainer} interface. It
adds the capacity to contain other components to {@link
com.vaadin.ui.Component} with a simple API.

The third and last level is the L{com.vaadin.ui.Layout},
which adds the concept of location to the components contained in a
L{com.vaadin.ui.ComponentContainer}. It can be used to create
containers which contents can be positioned.

Component class hierarchy
-------------------------

At the top level is L{com.vaadin.ui.AbstractComponent} which
implements the L{com.vaadin.ui.Component} interface. As the name
suggests it is abstract, but it does include a default implementation
for all methods defined in C{Component} so that a component is
...
abstract extensions. L{com.vaadin.ui.AbstractComponentContainer}
