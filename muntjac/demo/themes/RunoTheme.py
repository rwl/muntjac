...
class RunoTheme(Application):
    ...
    def init(self):
        ...
        title = Label('Vaadin Runo Theme')
        title.addStyleName(Runo.LABEL_H1)
        title.setSizeUndefined()
        root.addComponent(title)
        root.setComponentAlignment(title, Alignment.TOP_CENTER)
        slogan = Label('Presenting a Stylish Alternative for the Traditional Desktop-Look')
        ...
        accordion.addTab(Label(''), 'Preferences', None)
        accordion.addTab(Label(''), 'Quick Search', None)
    ...
    def buildTree(self):
        ...
        # Spacing
        margin.addComponent(Label('&nbsp;', Label.CONTENT_XHTML))
        text = Label('The above tree and the example screens on the right don\'t actually do anything, they are here purely for show.')
    ...
    def buildWelcomeScreen(self):
        ...
        text = Label('<h3>A Complete Theme</h3><p>The Runo theme is a complete, general purpose theme suitable for many types of applications.</p><p>The name Runo is a Finnish word, meaning \"a poem\" in English. It is also used to refer to a very particular kind of female reindeer.</p>', Label.CONTENT_XHTML)
        ...
        text.setWidth('20px')
        texts.addComponent(text)
        text = Label('<h3>The Names of The Styles</h3><p>Look for a class named <code>Runo</code> inside the Vaadin JAR (<code>com.vaadin.ui.themes.Runo</code>).</p><p>All the available style names are documented and available there as constants, prefixed by component names, e.g. <code>Runo.BUTTON_SMALL</code>.</p>', Label.CONTENT_XHTML)
        texts.addComponent(text)
        texts.setExpandRatio(text, 1)
        l.addComponent(Label('<hr />', Label.CONTENT_XHTML))
        texts = HorizontalLayout()
        ...
        text = Label('<h4>About This Application</h4>In addition to this welcome screen, you\'ll find the style name reference and sample views within the two other main tabs.', Label.CONTENT_XHTML)
        text.addStyleName(Runo.LABEL_SMALL)
        texts.addComponent(text)
        texts.setExpandRatio(text, 1)
        # Spacer
    ...
    def buildLabels(self):
        ...
        l.setMargin(True)
        l.setCaption('Labels')
        l.addComponent(Label('Header Style (<code>Runo.LABEL_H1</code>)', Label.CONTENT_XHTML))
        label = Label('Lorem Ipsum')
        label.addStyleName(Runo.LABEL_H1)
        l.addComponent(label)
        l.addComponent(Label('Sub-header Style (<code>Runo.LABEL_H2</code>)', Label.CONTENT_XHTML))
        ...
        l.addComponent(Label('Small Style (<code>Runo.LABEL_SMALL</code>)', Label.CONTENT_XHTML))
    ...
    def buildButtons(self):
        ...
        l.addComponent(b)
        l.addComponent(Label('\"Default\" Style<br />(<code>Runo.BUTTON_DEFAULT</code>)', Label.CONTENT_XHTML))
        b = Button('Default Button')
        b.setStyleName(Runo.BUTTON_DEFAULT)
        l.addComponent(b)
        l.addComponent(Label('Big Style<br />(<code>Runo.BUTTON_BIG</code>)', Label.CONTENT_XHTML))
        b = Button('Big Button')
        b.setStyleName(Runo.BUTTON_BIG)
        l.addComponent(b)
        l.addComponent(Label('Big Default<br />(<code>Runo.BUTTON_BIG & Runo.BUTTON_DEFAULT</code>)', Label.CONTENT_XHTML))
        b = Button('Big Default')
        b.setStyleName(Runo.BUTTON_BIG)
        b.addStyleName(Runo.BUTTON_DEFAULT)
        l.addComponent(b)
        l.addComponent(Label('Small Style<br />(<code>Runo.BUTTON_SMALL</code>)', Label.CONTENT_XHTML))
        b = Button('Small Button')
        b.setStyleName(Runo.BUTTON_SMALL)
        l.addComponent(b)
        l.addComponent(Label('Small Default<br />(<code>Runo.BUTTON_SMALL & Runo.BUTTON_DEFAULT</code>)', Label.CONTENT_XHTML))
        b = Button('Small Default')
        b.setStyleName(Runo.BUTTON_SMALL)
        b.addStyleName(Runo.BUTTON_DEFAULT)
        l.addComponent(b)
        l.addComponent(Label('Disabled Button<br />(<code>Button.setEnabled(false)</code>)', Label.CONTENT_XHTML))
        b = Button('Disabled Button')
        b.setEnabled(False)
        l.addComponent(b)
        l.addComponent(Label('Link Style<br />(<code>Runo.BUTTON_LINK</code>)', Label.CONTENT_XHTML))
    ...
    def buildTextFields(self):
        ...
        l.addComponent(tf)
        l.addComponent(Label('Small Style (<code>Runo.TEXTFIELD_SMALL</code>)', Label.CONTENT_XHTML))
        tf = TextField()
        ...
        tf.setInputPrompt('Enter text')
        l.addComponent(tf)
        l.addComponent(Label('Small Style TextArea (<code>Runo.TEXTFIELD_SMALL</code>)', Label.CONTENT_XHTML))
        tf = TextField()
        tf.setHeight('5em')
        tf.setStyleName(Runo.TEXTFIELD_SMALL)
        tf.setInputPrompt('Enter text')
    ...
    def buildSelects(self):
        ...
        l.setMargin(True)
        l.setSpacing(True)
        l.addComponent(Label('Selects don\'t currently have any additional style names.'))
        hl = HorizontalLayout()
        hl.setSpacing(True)
    ...
    def buildDateFields(self):
        ...
        l.setMargin(True)
        l.setSpacing(True)
        l.addComponent(Label('Date fields don\'t currently have any additional style names.'))
        hl = HorizontalLayout()
        hl.setSpacing(True)
        hl.setMargin(True, False, False, False)
        l.addComponent(hl)
    ...
    def buildTabSheets(self):
        ...
        ts.setHeight('100px')
        l.addComponent(ts)
        l.addComponent(Label('Small Style (<code>Runo.TABSHEET_SMALL</code>)', Label.CONTENT_XHTML))
        ts2 = TabSheet()
    ...
    def buildPanels(self):
        ...
        l.addComponent(p)
        l.addComponent(Label('Light Style (<code>Runo.PANEL_LIGHT</code>)', Label.CONTENT_XHTML))
    ...
    def buildTables(self):
        ...
        while True:
            ...
            if i == 2:
                ...
                l.addComponent(Label('Small Style (<code>Runo.TABLE_SMALL</code>)', Label.CONTENT_XHTML))
            elif i == 1:
                t.setStyleName(Runo.TABLE_BORDERLESS)
                l.addComponent(Label('Borderless Style (<code>Runo.TABLE_BORDERLESS</code>)', Label.CONTENT_XHTML))
            elif i == 3:
                t.setStyleName(Runo.TABLE_BORDERLESS)
                t.addStyleName(Runo.TABLE_SMALL)
                l.addComponent(Label('Borderless & Small (<code>Runo.TABLE_BORDERLESS & Runo.TABLE_SMALL</code>)', Label.CONTENT_XHTML))
            else:
    ...
    def buildWindows(self):
        ...
        w2.setPositionX(400)
        w2.setPositionY(200)
        w2.addComponent(Label('<code>Runo.WINDOW_DIALOG</code>', Label.CONTENT_XHTML))
    ...
    def buildSplitPanels(self):
        ...
        sp.setHeight('120px')
        l.addComponent(sp)
        l.addComponent(Label('Reduced Style (<code>Runo.SPLITPANEL_REDUCED</code>)', Label.CONTENT_XHTML))
        sp2 = HorizontalSplitPanel()
        sp2.setStyleName(Runo.SPLITPANEL_REDUCED)
        sp2.setWidth('100px')
        sp2.setHeight('120px')
        l.addComponent(sp2)
        l.addComponent(Label('Small Style (<code>Runo.SPLITPANEL_SMALL</code>)', Label.CONTENT_XHTML))
    ...
    def buildAccordions(self):
        ...
        l.addComponent(Label('Normal Accordion', Label.CONTENT_XHTML))
        a = Accordion()
        a.setWidth('100%')
        a.setHeight('170px')
        l.addComponent(a)
        l.addComponent(Label('Light Style<br />(<code>Runo.ACCORDION_LIGHT</code>)', Label.CONTENT_XHTML))
        a2 = Accordion()
        a2.setWidth('100%')
        a2.setHeight('170px')
        ...
        while True:
            ...
            if not (i < 4):
                break
            a.addTab(Label(), 'Sheet ' + i, None)
            a2.addTab(Label(), 'Sheet ' + i, None)
        return l
    ...
    def buildSliders(self):
        ...
        l.setWidth('400px')
        l.setColumnExpandRatio(0, 1)
        l.addComponent(Label('Normal Slider', Label.CONTENT_XHTML))
        s = Slider()
        s.setWidth('200px')
    ...
    def buildLayouts(self):
        ...
        l.setWidth('550px')
        l.setColumnExpandRatio(0, 1)
        l.addComponent(Label('Box Shadow<br />(<code>Runo.CSSLAYOUT_SHADOW</code>)', Label.CONTENT_XHTML))
        layout = CssLayout()
        ...
        l.addComponent(Label('Selectable<br />(<code>Runo.CSSLAYOUT_SELECTABLE</code> & <code>Runo.CSSLAYOUT_SELECTABLE_SELECTED</code>)', Label.CONTENT_XHTML))
        layout = CssLayout()
    ...
    def buildBillingScreen(self):
        ...
        class _5_(Button.ClickListener):
            ...
            def buttonClick(self, event):
                ...
                text = Label('Coarse info')
                text.setSizeUndefined()
                text.addStyleName(Runo.LABEL_SMALL)
                labels.addComponent(text)
                text = Label('Fine details')
                text.setSizeUndefined()
                text.addStyleName(Runo.LABEL_SMALL)
                labels.addComponent(text)
        ...
        i.getItemProperty('desc').setValue('More revisions')
        i.getItemProperty('note').setValue(None)
        content.addComponent(Label('<hr />', Label.CONTENT_XHTML))
        ...
        line.addComponent(Label('Customer Hourly Rate:'))
        tf = TextField()
        ...
        line.addComponent(first)
        first.setWidth('80px')
        first = Label('11:56:10 from 1 timing session.')
        line.addComponent(first)
    ...
    def buildLibraryScreen(self):
        ...
        text = Label('Note: the book cover images are not included in the Runo theme, they are provided extenally for this example. The shadow for the books is supplied by the theme.')
        text.addStyleName(Runo.LABEL_SMALL)
        text.setWidth('90%')
        ...
        title = Label('<h3>Graphic Design &ndash; The New Basics</h3>', Label.CONTENT_XHTML)
        ...
        text = Label('248 pages')
        text.setCaption('Hardcover:')
        l.addComponent(text)
        text = Label('Princeton Architectural Press; 1 edition (May 1, 2008)')
        text.setCaption('Publisher:')
        l.addComponent(text)
        text = Label('English')
        text.setCaption('Language:')
        l.addComponent(text)
        text = Label('1568987706')
        text.setCaption('ISBN-10:')
        l.addComponent(text)
        text = Label('978-1568987705')
        text.setCaption('ISBN-13:')
        l.addComponent(text)
        text = Label('9.1 x 8.1 x 1.1 inches')
        text.setCaption('Product Dimensions:')
        l.addComponent(text)
        text = Label('2.2 pounds')
        text.setCaption('Shipping Weight:')
        l.addComponent(text)
        tabs.addTab(Label(), 'Reviews', None)
        tabs.addTab(Label(), 'Personal', None)
        return root
