...
class ReindeerThemeStyles(Application):
    ...
    def buildLabels(self):
        ...
        l.addComponent(ALabel('Header Style (<code>Reindeer.LABEL_H1</code>)', ALabel.CONTENT_XHTML))
        l.addComponent(self.H1('Lorem Ipsum'))
        l.addComponent(ALabel('Sub-header Style (<code>Reindeer.LABEL_H2</code>)', ALabel.CONTENT_XHTML))
        ...
        l.addComponent(ALabel('Small Style (<code>Reindeer.LABEL_SMALL</code>)', ALabel.CONTENT_XHTML))
    ...
    def buildButtons(self):
        ...
        l.addComponent(ALabel('\"Default\" Style (<code>Reindeer.BUTTON_DEFAULT</code>)', ALabel.CONTENT_XHTML))
        ...
        l.addComponent(b)
        l.addComponent(ALabel('Disabled Button (<code>Button.setEnabled(false)</code>)', ALabel.CONTENT_XHTML))
        b = Button('Disabled Button')
        b.setEnabled(False)
        l.addComponent(b)
        l.addComponent(ALabel('Small Style (<code>Reindeer.BUTTON_SMALL</code>)', ALabel.CONTENT_XHTML))
        b = Button('Small Button')
        b.setStyleName(Reindeer.BUTTON_SMALL)
        l.addComponent(b)
        l.addComponent(ALabel('Link Style (<code>Reindeer.BUTTON_LINK</code>)', ALabel.CONTENT_XHTML))
    ...
    def buildTextFields(self):
        ...
        l.addComponent(tf)
        l.addComponent(ALabel('Small Style (<code>Reindeer.TEXTFIELD_SMALL</code>)', ALabel.CONTENT_XHTML))
        tf = TextField()
        ...
        tf.setInputPrompt('Enter text')
        l.addComponent(tf)
        l.addComponent(ALabel('Small Style TextArea (<code>Reindeer.TEXTFIELD_SMALL</code>)', ALabel.CONTENT_XHTML))
        tf = TextField()
        tf.setHeight('5em')
        tf.setStyleName('small')
        tf.setInputPrompt('Enter text')
    ...
    def buildSelects(self):
        ...
        l.setMargin(True)
        l.setSpacing(True)
        l.addComponent(ALabel('Selects don\'t currently have any additional style names, but here you can see how they behave with the different background colors.'))
        hl = HorizontalLayout()
        hl.setSpacing(True)
    ...
    def buildDateFields(self):
        ...
        l.setMargin(True)
        l.setSpacing(True)
        l.addComponent(ALabel('Date fields don\'t currently have any additional style names, but here you can see how they behave with the different background colors.'))
        hl = HorizontalLayout()
        hl.setSpacing(True)
        hl.setMargin(True, False, False, False)
        l.addComponent(hl)
    ...
    def buildTabSheets(self):
        ...
        ts.setHeight('100px')
        l.addComponent(ts)
        l.addComponent(ALabel('Borderless Style (<code>Reindeer.TABSHEET_BORDERLESS</code>)', ALabel.CONTENT_XHTML))
        ts2 = TabSheet()
        ts2.setStyleName(Reindeer.TABSHEET_BORDERLESS)
        ts2.setHeight('100px')
        l.addComponent(ts2)
        l.addComponent(ALabel('Small Style (<code>Reindeer.TABSHEET_SMALL</code>)', ALabel.CONTENT_XHTML))
        ts3 = TabSheet()
        ts3.setStyleName(Reindeer.TABSHEET_SMALL)
        l.addComponent(ts3)
        l.addComponent(ALabel('Minimal Style (<code>Reindeer.TABSHEET_MINIMAL</code>)', ALabel.CONTENT_XHTML))
        ts4 = TabSheet()
        ...
        while True:
            ...
            ts3.addTab(ALabel(), 'Tab ' + i, None)
            ts4.addTab(ALabel(), 'Tab ' + i, None)
    ...
    def buildPanels(self):
        ...
        l.addComponent(p)
        l.addComponent(ALabel('Light Style (<code>Reindeer.PANEL_LIGHT</code>)', ALabel.CONTENT_XHTML))
    ...
    def buildTables(self):
        ...
        while True:
            ...
            if i == 1:
                ...
                l.addComponent(ALabel('Strong Style (<code>Reindeer.TABLE_STRONG</code>)', ALabel.CONTENT_XHTML))
            elif i == 2:
                t.setStyleName('borderless')
                l.addComponent(ALabel('Borderless Style (<code>Reindeer.TABLE_BORDERLESS</code>)', ALabel.CONTENT_XHTML))
            elif i == 3:
                t.setStyleName('borderless strong')
                l.addComponent(ALabel('Borderless & Strong Combined', ALabel.CONTENT_XHTML))
            else:
    ...
    def buildWindows(self):
        ...
        w3.setPositionX(40)
        w3.setPositionY(370)
        w3.addComponent(ALabel('<code>Reindeer.WINDOW_LIGHT</code>', ALabel.CONTENT_XHTML))
        ...
        w4.setPositionX(350)
        w4.setPositionY(370)
        w4.addComponent(ALabel('<code>Reindeer.WINDOW_BLACK</code>', ALabel.CONTENT_XHTML))
    ...
    def buildSplitPanels(self):
        ...
        sp.setHeight('200px')
        l.addComponent(sp)
        l.addComponent(ALabel('Small Style (<code>Reindeer.SPLITPANEL_SMALL</code>)', ALabel.CONTENT_XHTML))
    ...
    def buildWelcomeScreen(self):
        ...
        text = ALabel('<h4>A Complete Theme</h4><p>The Reindeer theme is a complete, general purpose theme suitable for almost all types of applications.<p>While a general purpose theme should not try to cater for every possible need, the Reindeer theme provides a set of useful styles that you can use to make the interface a bit more lively and interesing, emphasizing different parts of the application.</p>', ALabel.CONTENT_XHTML)
        ...
        text.setWidth('20px')
        texts.addComponent(text)
        text = ALabel('<h4>The Names of The Styles</h4><p>Look for a class named <code>Reindeer</code> inside the Vaadin JAR (<code>com.vaadin.ui.themes.Reindeer</code>). All the available style names are documented and available there as constants, prefixed by component names, e.g. <code>Reindeer.BUTTON_SMALL</code>.', ALabel.CONTENT_XHTML)
        texts.addComponent(text)
        texts.setExpandRatio(text, 1)
        text = self.H2('One Theme &ndash; Three Styles')
        text.setContentMode(ALabel.CONTENT_XHTML)
        margin.addComponent(text)
        margin.addComponent(self.Ruler())
        text = ALabel('<p>You can easily change the feel of some parts of your application by using the three layout styles provided by Reindeer: white, blue and black. The colored area contains the margins of the layout. All contained components will switch their style if an alternative style is available for that color.</p>', ALabel.CONTENT_XHTML)
        margin.addComponent(text)
        ...
        color.addComponent(ALabel('<p><strong><code>Reindeer.LAYOUT_WHITE</code></strong></p><p>Changes the background to white. Has no other effect on contained components, they all behave like on the default gray background.', ALabel.CONTENT_XHTML))
        ...
        color.addComponent(ALabel('<p><strong><code>Reindeer.LAYOUT_BLUE</code></strong></p><p>Changes the background to a shade of blue. A very few components have any difference here compared to the white style.', ALabel.CONTENT_XHTML))
        colors.addComponent(color)
        color = CssLayout()
        color.setSizeFull()
        ...
        color.addComponent(ALabel('<p><strong><code>Reindeer.LAYOUT_BLACK</code></strong></p><p>Reserved for small parts of the application. Or alternatively, use for the whole application.</p><p><strong>This style is non-overridable</strong>, meaning that everything you place inside it will transform to their corresponding black styles when available, excluding Labels.</p>', ALabel.CONTENT_XHTML))
        colors.addComponent(color)
        text = ALabel('<p>Note, that you cannot nest the layout styles infinitely inside each other. After a couple levels, the result will be undefined, due to limitations in CSS (which are in fact caused by Internet Explorer 6).</p>', ALabel.CONTENT_XHTML)
        margin.addComponent(text)
        return l
    ...
    def getHeader(self):
        ...
        bgColor = ALabel('Background color')
    ...
    def openHelpWindow(self):
        if not ('initialized' == self._help.getData()):
            ...
            helpText = ALabel('<strong>How To Use This Application</strong><p>Click around, explore. The purpose of this app is to show you what is possible to achieve with the Reindeer theme and its different styles.</p><p>Most of the UI controls that are visible in this application don\'t actually do anything. They are purely for show, like the menu items and the components that demostrate the different style names assosiated with the components.</p><strong>So, What Then?</strong><p>Go and use the styles you see here in your own application and make them beautiful!', ALabel.CONTENT_XHTML)
    ...
    def openLogoutWindow(self):
        ...
        helpText = ALabel('Are you sure you want to log out? You will be redirected to vaadin.com.', ALabel.CONTENT_XHTML)
    ...
    class Ruler(ALabel):
        ...
        def __init__(self):
            super(Ruler, self)('<hr />', ALabel.CONTENT_XHTML)
