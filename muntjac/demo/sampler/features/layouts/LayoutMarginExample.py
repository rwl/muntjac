...
class LayoutMarginExample(GridLayout, Button.ClickListener):
    _marginLayout = None
    _topMargin = None
    _rightMargin = None
    _bottomMargin = None
    ...
    def __init__(self):
        ...
        self.addComponent(ALabel('Toggle layout margins with the checkboxes. The right side margin has a theme-specified value, while the other margins are the defaults.'), 0, 0, 2, 0)
        self.space()
        ...
        self._marginLayout.addComponent(ALabel('Margins all around?'))
