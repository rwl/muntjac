...
class JSApiExample(VerticalLayout):
    ...
    def __init__(self):
        ...
        class RunListener(button.IClickListener):
            ...
            def buttonClick(self, event):
                self._component.getWindow().executeJavaScript(
                        str(self.script.getValue()))

        self.addComponent(Button('Run script', RunListener(self)))
        ...
        self.toBeUpdatedFromThread = Label(("This Label component will be "
        ...
        class StartListener(button.IClickListener):
