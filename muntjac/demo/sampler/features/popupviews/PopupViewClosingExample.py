...
class PopupViewClosingExample(VerticalLayout, PopupView.PopupVisibilityListener):
    ...
    def __init__(self):
        ...
        content = ALabel('This popup will close as soon as you move the mouse cursor outside of the popup area.')
        ...
        content = ALabel('This popup will only close if you click the mouse outside the popup area.')
        # The PopupView popup will be as large as needed by the content
        content.setWidth('300px')
